    ...
    element[0].addEventListener('click', function () {
        ...
        let timer = setInterval(function () {
            ...
            if (flag) {
                ...
                document.location.href.substring(addresExecution(document.location.href), document.location.href.length) == '' ? document.getElementsByClassName('burgerHeaderImg')[0].src = './src/img/icons/fi_x.svg' : document.getElementsByClassName('burgerHeaderImg')[0].src = '../src/img/icons/fi_x.svg';
                ...
                document.location.href.substring(addresExecution(document.location.href), document.location.href.length) == '' ? document.getElementsByClassName('burgerHeaderImg')[0].src = './src/img/icons/fi_menu.svg' : document.getElementsByClassName('burgerHeaderImg')[0].src = '../src/img/icons/fi_menu.svg';

...
const mobileMenu = () =>{
    ...
    if(flag){
        ...
        document.location.href.substring(0,addresExecution(document.location.href)) ==  'index' ? document.getElementsByClassName('burgerHeaderImg')[0].src = './course-project/src/img/icons/fi_x.svg' : document.getElementsByClassName('burgerHeaderImg')[0].src = './course-project/src/img/icons/fi_x.svg';
      if (timePassed > header.offsetHeight-8) clearInterval(timer);
        ...
        document.location.href.substring(0,addresExecution(document.location.href)) ==  'index' ? document.getElementsByClassName('burgerHeaderImg')[0].src = './course-project/src/img/icons/fi_menu.svg' : document.getElementsByClassName('burgerHeaderImg')[0].src = './course-project/src/img/icons/fi_menu.svg';
